...
export const generateOfflineClosingPdf = async ({
  ...
  const rows: Array<[string, string]> = [
    ...
    ["Scratch revenue", money(closing.lottery_total_scratch_revenue)],
    ["Lottery online", money(closing.lottery_online_amount)],
    ["Lottery paid out", money(closing.lottery_paid_out_amount)],
    ["Lottery amount due", money(closing.lottery_amount_due)],
